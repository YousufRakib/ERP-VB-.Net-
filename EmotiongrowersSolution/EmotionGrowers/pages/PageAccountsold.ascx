...
<div id="DialogDepositSummary" style="display: none;">
    <fieldset id="fsDepositSummary" style="font-size: 18px; font-weight: bold; height: 80px; border-width: 1px; margin-top: 10px; border-radius: 5px;">
        <legend style="background: white; margin-left: 2px;"></legend>
        <table>
            <tr>
                <td colspan="2">
...
<div id="DialogByDeposit" style="display: none;">
    <fieldset id="fsByDeposit" style="font-size: 18px; font-weight: bold; height: 100px; border-width: 1px; margin-top: 10px; border-radius: 5px;">
        <legend style="background: white; margin-left: 2px;"></legend>
        <table>
            <tr style="height: 33px;">
                <td style="padding-right: 10px;">
...
<script type="text/javascript">
    ...
    $(document).ready(new function () {
        ...
        $("#txtDateFrom,#txtDepositFrom").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: 'mm/dd/yy',
            showOtherMonths: true,
        ...
        $("#txtDateTo,#txtDepositTo").datepicker({
            changeMonth: true,
            changeYear: true,
            dateFormat: 'mm/dd/yy',
            showOtherMonths: true,
...
function PrintDepositReports(DepositFrom, DepositTo, CheckNo, BankNo, CustomerNo, FromDate, ToDate, DepositType) {
    //debugger;
    var w = window.open('GeneratingPDF.html');
    ...
    $.ajax({
        ...
        data: "{'DepositFrom':'" + DepositFrom + "','DepositTo':'" + DepositTo + "','CheckNo':'" + CheckNo + "','BankNo':'" + BankNo + "', 'CustomerNo':'" + CustomerNo + "','FromDate':'" + FromDate + "','ToDate': '" + ToDate + "','DepositType':'" + DepositType + "'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (output) {
            //debugger;
...
$("#DialogDepositSummary").dialog({
    ...
    buttons: {
        Print: function () {
            ...
            //debugger;
            PrintDepositReports('0', '0', '0', '1', '0', ARSessionFromDt, ARSessionToDt, DepositType+"~"+CheckedAllDepositValue);
        },
        Close: function () {
            $(this).dialog("close");
        }
...
$("#DialogAllDeposits").dialog({
    ...
    buttons: {
        Next: function () {
            ...
            else if (CheckedAllDepositValue == "ByCustomer") {
                $("#DialogByCustomer").dialog("open").data("DepositType", DepositType);
            }
...
$("#DialogByDeposit").dialog({
    ...
    buttons: {
        Print: function () {
            ...
            PrintDepositReports('0', '0', '0', '1', '0', DepositFrom, DepositTo, DepositType);
        },
        Close: function () {
            $(this).dialog("close");
        }
...
$("#DialogByCustomer").dialog({
    autoOpen: false,
    resizable: false,
    title: "Deposits List By Customer",
    width: 400,
    height: 200,
    modal: true,
    buttons: {
        Print: function () {
            ...
            var DepositType = $("#DialogByCustomer").data("DepositType");
            /*Don't force to enter Cust# :: ABI ::02Feb2018
            if (CustomerNo == "") {
                $.MessageBox("Please Enter customer number");
                return false;
            }*/
            PrintDepositReports('0', '0', '0', '1', CustomerNo, '', '', DepositType);
        },
        Close: function () {
            $(this).dialog("close");
        }
