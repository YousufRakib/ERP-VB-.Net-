                ...
                if (AWB!= "" && BOXES!= "") {
                    ...
                    success: function (output) {
                        ...
                        if (output.d == "success") {
                            ...
                            var frieght = $("#row" + ID).children("td")[7];
                            $(frieght).children().text(FREIGHT.toFixed(2));
                            var totalfrieght = $("#row" + ID).children("td")[8];
                            $(totalfrieght).children().text((FREIGHT / BOXES).toFixed(2));
                            var handling = $("#row" + ID).children("td")[9];
                            $(handling).children().text(HANDLING.toFixed(2));
                            var totalfrieght = $("#row" + ID).children("td")[10];
                            $(totalfrieght).children().text((HANDLING / BOXES).toFixed(2));
                            ...
                            $(amount).children().text((FREIGHT + HANDLING + FUMIGATION + OTHERCHARGES).toFixed(2));
